...
function mainFunk(a, b, callback) {
...
console.log(mainFunk(2, 5, cbRandom));
console.log(mainFunk(2, 5, cbPow));
console.log(mainFunk(2, 5, cbAdd));
console.log(mainFunk(2, 5, 'not a func'));
